/*
 * TerminalAmountComponent.js
 *
 * Komponent for å justere antall terminaler i B_BestillComponent.
 * Har min-verdi på 0 og max-verdier på 999.
 * 
 * Lagd av 6004
 */

function TerminalAmount({ num, setNum }) {
